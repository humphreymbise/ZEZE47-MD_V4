...
const author = process.env.STICKER_AUTHOR ||'ZEZE TECH';
const packname = process.env.STICKER_PACKNAME || 'ZEZE47-MD';
const antitag = process.env.ANTITAG || 'TRUE';
const dev = process.env.DEV || '255629667675';
const menulink = process.env.MENU_LINK || 'https://i.imgur.com/VwloR6v.jpeg';
