...
//========================================================================================================================//		      
        ...
        async function redeployApp() {
            try {
                ...
                await m.reply("Your bot is undergoing a ruthless upgrade, hold tight for the next 2 minutes as the redeploy executes! Once done, you’ll have the freshest version of *zeze-BOT* unleashed upon you.");
...
//========================================================================================================================//		      
	      case 'metallic': {
		     ...
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Metallic Zeze");
      return;
    }
     try {
...
//========================================================================================================================//		      
	      case 'ice': {
		      var mumaker = require("mumaker");
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Ice Zeze");
      return;
    }
     try {
...
//========================================================================================================================//		      
		 ...
		 var mumaker = require("mumaker");
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "purple Faith");
      return;
    }
     try {
...
//========================================================================================================================//		      
	...
	try {
    var _0x14192 = await mumaker.ephoto("https://en.ephoto360.com/2006-style-text-effect-523.html", text);
    m.reply("Wait a moment...");
    await client.sendMessage(m.chat, {
      image: {
        url: _0x14192.image
...
case "support": {
    ...
    const 𝕭𝖑𝖆𝖈𝖐𝖞 = {
        links: {
            ...
            github: "not now"/issues",
            developer: "https://wa.me/255747397675"
        },
        media: {
            banner: "https://i.imgur.com/wZcGmu7.jpeg"
        }
    };
...
//========================================================================================================================//		      
	      case "vision": {
		      if (!msgR || !text) {
    m.reply("𝗤𝘂𝗼𝘁𝗲 𝗮𝗻 𝗶𝗺𝗮𝗴𝗲 𝗮𝗻𝗱 𝗴𝗶𝘃𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵. 𝗜'𝗺 𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝗔𝗶, 𝗶 𝘂𝘀𝗲 𝗕𝗮𝗿𝗱 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘇𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    return;
  }
  ;
  let _0x44b3e0;
...
await client.sendMessage(m.chat, { image: { url: imageurl}, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃-𝗕𝗢𝗧`}, { quoted: m}) 
...
//========================================================================================================================//		      
 ...
 if (!Owner) throw NotOwner;  
     ...
     let stoy = '*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝐁𝐎𝐓:*\n\n';  
...
if (users == "25547397675@s.whatsapp.net") return m.reply("It's an Owner Number! 😡");
...
await client.sendMessage(m.chat,{video : {url : twtvid },caption : `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝐁𝐎𝐓`,gifPlayback : false },{quoted : m}) 
...
if (!text) {
    ...
    try {
        ...
        await client.sendMessage(
            ...
            {
                video: { url: fbvid },
                caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝐁𝐎𝐓",
                gifPlayback: false,
            },
            { quoted: m }
        );
...
try {
        ...
        const capp = `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃`;
...
case 'sc': case 'script': case 'repo':
 ...
 client.sendMessage(m.chat, { image: { url: `https://i.imgur.com/wZcGmu7.jpeg` }, caption: 
` What's up ❣️ *${pushname}*,
╔══≪ ✦ ≫══════════≪ ✦ ≫══╗
          𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝐕4
 Enjoying your what's app 
╚══≪ ✦ ≫══════════≪ ✦ ≫══╝\n\n🔷 what's app channel :
   ↳ https://whatsapp.com/channel/0029VbANIT5D8SDpK7oExi1v
   developer by 𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃
╚══≪ ✦ ≫═══════════════≪ ✦ ≫══╝\n\nkimg zeze!`},{quoted : m });
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝐁𝐎𝐓-𝗔𝗶 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m }); 
...
//========================================================================================================================//		      
     case "hidetag": case "tag": { 
             ...
             if (!isBotAdmin) throw botAdmin; 
             if (!isAdmin) throw admin; 
            client.sendMessage(m.chat, { text : q ? q : 'ZEZE47-MD 𝗕𝗹𝗶𝗻𝗱 𝗧𝗮𝗴𝘀😅' , mentions: participants.map(a => a.id)}, { quoted: m }); 
             } 
 break; 
...
//========================================================================================================================//		      
	case 'runtime':
		let raven = `𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 ${runtime(process.uptime())}`
                client.sendMessage(m.chat, {
                    text: raven,
                    contextInfo: {
                        externalAdReply: {
...
//========================================================================================================================//		      
 ...
 const apiUrl = `https://api.dreaded.site/api/lyrics?title=${encodeURIComponent(text)}`;
    ...
    try {
        ...
        const imageUrl = thumb || "https://i.imgur.com/wZcGmu7.jpeg";
...
//========================================================================================================================//		      
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝐁𝐎𝐓`}, { quoted: m }) 
...
//========================================================================================================================//		      
 case "gemini": {
    try {
        if (!text) return m.reply("This is Zeze-MD, an AI using Gemini APIs to process text, provide yr query");
...
case "block": { 
 ...
 let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
	 if (users == "255747397675@s.whatsapp.net") return m.reply("𝗜 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗹𝗼𝗰𝗸 𝗺𝘆 𝗢𝘄𝗻𝗲𝗿 😡");
